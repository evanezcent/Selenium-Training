...
Feature: checkin1
  ...
  Scenario: Admin akan menginput data customer yang akan atau sedang checkin
    And Admin click Check In Case 1
    And Admin fill Nama Lengkap Case 1
    And Admin fill NIK Case 1
    And Admin select Pilih kamar Case 1
    And Admin select fasilitas Case 1
    And Admin click button Check In Case 1
    When Admin click button Submit Check In Case 1
    Then Admin berada di halaman Home lagi Case 1